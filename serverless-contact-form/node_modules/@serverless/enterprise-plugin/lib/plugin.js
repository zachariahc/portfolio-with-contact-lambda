...
const _require3 = require('./variables'),
      hookIntoVariableGetter = _require3.hookIntoVariableGetter;

const _require4 = require('./generateEvent'),
      generate = _require4.generate,
      eventDict = _require4.eventDict;

const _require5 = require('./deployProfile'),
      configureDeployProfile = _require5.configureDeployProfile;

const _require6 = require('./test'),
      test = _require6.test;

const _require7 = require('./dashboard'),
      getDashboardUrl = _require7.getDashboardUrl;
...
class ServerlessEnterprisePlugin {
  constructor(sls) {
    ...
    sls.service.tenant = sls.service.org || sls.service.tenant; // Doubled check due to SLS bug: https://github.com/serverless/serverless/pull/6367
    ...
    if (missing.length > 0) {
      ...
      sls.enterpriseEnabled = true; // Set Plugin hooks for authenticated Enteprise Plugin features here
  ...
  asyncInit() {
    ...
    return _asyncToGenerator(function* () {
      if (!_this2.sls.enterpriseEnabled || _this2.sls.processedInput.commands[0] === 'login' || _this2.sls.processedInput.commands[0] === 'logout') {
        hookIntoVariableGetter(_this2, {});
        return;
      }
