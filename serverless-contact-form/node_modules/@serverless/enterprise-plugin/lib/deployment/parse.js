...
function () {
  var _ref = _asyncToGenerator(function* (ctx, status = 'success', error = null, archived = false) {
    ...
    if (!archived) {
      ...
      try {
        for (var _iterator = _.entries(outputs)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      for (var _i = 0, _Object$keys = Object.keys(service.functions); _i < _Object$keys.length; _i++) {
        ...
        try {
          for (var _iterator2 = fn.events[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
