...
module.exports = function dlqPolicy(policy, service) {
  ...
  const logicalFuncNamesToConfigFuncName = fromPairs(Object.keys(functions || {}).map(funcName => [naming.getLambdaLogicalId(funcName), funcName])); // for (const [name, { events, onError }] of entries(functions)) {
